<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      if($count == 1) {
         ...
         $error = "Usuário ou senha incorreto, tente novamente!";
      }
   }
?>
<html>
...
<br/><br/><br/><br/><br/>
	 <font size = "14" color = "#fff" ><center> Seja bem vindo! </center></font> 
	
<br/>
<div class="login-block">
    <h1>Login</h1>
	<form action = "" method = "post">
		<input type="text" value="" placeholder="Usuário" name="username" id ="username"/>
